    ...
    client.on('message', message => {
        ...
        if(message.content === prefix + "info") {
            ...
            .addField(":video_game: Nombre de membres :", message.guild.members.size, true)
            .addField(":game_die: Nombre de catégories et de salons :", message.guild.channels.size, true)
            .setFooter("Ce bot a été créé par iFKilleur#8181")
